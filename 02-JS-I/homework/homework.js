...
function tienenMismaLongitud(str1, str2) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código:
    var linea1 = str1.length
    var linea2 = str2.length
...
function esPositivo(numero) {
  ...
  // ok el resultado no es mayor, entonces..
  else{
    // si es menor a cero...
    if (numero < 0){
      return "Es negativo"
    }
    // si no es mayor ni menor que 0 entonces debe ser igual
    else{
      return false
    }
  }
...
function esVocal(letra){
  ...
  // Primero revisar si ingreso solo 1 letra:
  if (letra.length === 1){
